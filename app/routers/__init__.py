...
from . import (index, login, register, admin_home, user_home, users, logout, finance_router, expenses_router, subscriptions_router, budget_router, reports_router, savings_router, calendar_router)