        ...
        <div id="wrapper">
            <nav id="sidebar" class="p-3 d-flex flex-column vh-100">
                ...
                <ul class="nav nav-pills flex-column gap-2 flex-grow-1">
                    ...
                    <li class="nav-item"><a class="nav-link d-flex align-items-center active" href="/calendar/"><span class="material-symbols-outlined me-2">calendar_month</span>Calendar</a></li>
